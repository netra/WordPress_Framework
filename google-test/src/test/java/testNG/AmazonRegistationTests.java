...
public class AmazonRegistationTests {
	WebDriver driver;
	...
	@Test(priority = 1,groups="postive-Test")
	...
	@Test(priority = 2,groups="negative-test")
	...
	@Test(priority = 3,groups="negative-test")
	...
	@Test(priority = 4,groups="negative-test")
	...
	@Test(priority = 5,groups="negative-test")
